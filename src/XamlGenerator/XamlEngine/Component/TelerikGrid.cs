...
namespace XamlGenerator.Component
{
    ...
    //--------------------------------------------------------------------------------------------------------------------------------------------------//
        ...
        #region constructor
        public TelerikGrid(string EntityTypeName, string EntitySetName , IEnumerable<EntityMetaData> MetaDatas, ref IDataSourceManager DomainDataSourceManager)
        {
        ...
        public TelerikGrid(string EntityTypeName, string EntitySetName, IEnumerable<EntityMetaData> MetaDatas, ref IDataSourceManager DomainDataSourceManager, GridTypes gridType, string MasterGridName, string ChildBindingPath,string ParameterName)
        {
            this.XamlNameSpace = string.Empty; //--- telerik name space already included in datasource class namespace
            this.CodeBehindMethods = string.Empty;
            this.XamlCode = string.Empty;
