...
{
    class MasterDetails2RadDomainDataSource :IDataSourceManager
    {
        #region Property
        ...
        #region Constructor
        public MasterDetails2RadDomainDataSource(string EntityTypeName, string EntitySetName)
        {
        ...
        public void GetNewDetailsDomainDataSource(string Name, string QueryName, bool AutoLoad, string ParameterName, string BindingPath, string MasterGridName)
        {
            ...
            if (!this.DataSources.TryGetValue(QueryName, out value))
            {
                ...
                radDomainDataSource.CreateRadDomainDataSourceWithParameterInCodeBehind(ParameterName);
                this.DataSources.Add(QueryName, radDomainDataSource);
            }
        }
