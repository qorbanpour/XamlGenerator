...
namespace Silverlight.Controls
{
    ...
    internal static class CalendarExtensions
    {
        ...
        /// Inherited code: Requires comment.
        /// </summary>
        private static readonly Dictionary<DependencyObject, Dictionary<DependencyProperty, bool>> _suspendedHandlers = new Dictionary<DependencyObject, Dictionary<DependencyProperty, bool>>();
