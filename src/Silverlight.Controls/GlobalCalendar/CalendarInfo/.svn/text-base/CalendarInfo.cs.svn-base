...
namespace Silverlight.Controls
{
    ...
    public abstract class CalendarInfo
    {
        ...
        {
            get { return this.EnsureDateFormatInfo().FirstDayOfWeek; }
        }
        ...
        {
            DateTimeFormatInfo format = this.EnsureDateFormatInfo();
        ...
        {
            return day.ToString(this.EnsureDateFormatInfo());
        }
        ...
        {
            return day.ToString("%d", this.EnsureDateFormatInfo());
        }
        ...
        {
            return this.EnsureDateFormatInfo().AbbreviatedMonthNames[monthIndex];
        }
        ...
        {
            return this.EnsureDateFormatInfo().ShortestDayNames[dayOfWeekIndex];
        }
        ...
        {
            return day.ToString("Y", this.EnsureDateFormatInfo());
        }
        ...
        /// </returns>
        public virtual DateTime Parse(string date)
        {
            return DateTime.Parse(date, this.DateFormatInfo);
        }
        ...
        {
            return day.ToString("yyyy", this.EnsureDateFormatInfo());
        }
        ...
        {
            DateTimeFormatInfo info = this.DateFormatInfo;
            if( info == null )
                throw new InvalidOperationException(Assets.Resources.ControlsStrings.CalendarInfo_DateFormatInfoRequired);
